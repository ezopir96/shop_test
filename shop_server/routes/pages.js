...
const { getCartsList } = require('../middleware/carts')
...
router.get('/myinfo', getMyInfo, getBannerList, getUserInfo, (req, res) => {
  if (!req.result) {
    return res.render('index.html', {list: req.banner, nickname: req.nickname})
  }
